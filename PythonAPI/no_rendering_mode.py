...
class ModuleWorld(object):
    ...
    def __init__(self, name, host, port, timeout, actor_filter, no_rendering=True, show_triggers=False):
        self.client = None
        self.name = name
        self.host = host
        self.port = port
...
def game_loop(args):
    ...
    world_module = ModuleWorld(MODULE_WORLD, args.host, args.port, 2.0, args.filter, args.no_rendering, args.show_triggers)
